	...
	<div id="root-find">
		...
		<div id="topBar-find">
			<div class="find-navbar-left">
				<a href="../in/naverin_main.jsp" style="width: 81px; height: 26px; margin-left: 5%;">
					<img src="./resources/img/logo-md.png" alt="img">
				</a> 
				<div style="width: 130px; margin-left: 20px;">
					<input type="button" class="textBtn" value="아이디 찾기" style="color: white; font-weight: 900;">
				</div>
				<div style="width: 130px; color: white; font-weight: 900;">
					<input type="button" onclick="location.href='find_pwd.jsp'" class="textBtn" value="비밀번호 찾기">
				</div>
			</div>
		...
		<div class="find-wrap">
			<form name="checkFrm" action="find_idProc.jsp" method="post">
				<div style="height:10%; margin-left: 20px; margin-top: 50px; margin-bottom: 10px;">
					<span style="font-weight: 900;">
						회원가입 시 입력한 이름과 전화번호로 찾기
					</span>
				</div>
				...
				<div style="height:10%; display: flex; justify-content: flex-end; margin-left: 20px;">
					<input type="button" onclick="check()"class="submitBtn" value="아이디 찾기">
				</div>
			</form>
		</div>
	</div>
